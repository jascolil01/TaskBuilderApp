...
// Small hand-drawn class emblems, one per attribute. Shared between Avatar
// and ShareCardSvg so both render the exact same iconography.
export const EMBLEMS: Record<AttributeKey, ReactNode> = {
  // Warrior — sword
  STR: (
